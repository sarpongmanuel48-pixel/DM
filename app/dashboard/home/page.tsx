...
// 3A (+ 2E's expired banner, + 4D's first-run checklist).
export default async function DashboardHomePage() {
  ...
  const checklist = [
    { label: "Connect Whop and import offers", done: creator.whopConnectionStatus !== "DISCONNECTED", href: undefined },
    { label: "Write your bio and tagline", done: Boolean(creator.bio && creator.tagline), href: "/dashboard/editor" },
    {
  ...
  return (
    <div className="flex flex-col gap-5">
      {creator.whopConnectionStatus === "EXPIRED" && <ReconnectBanner lastSyncedAt={creator.lastSyncedAt} />}
      ...
      <div className="flex items-end justify-between gap-6">
        ...
        <div className="flex flex-none gap-2.5">
          ...
          <Link href="/dashboard/editor" className="qbx-btn qbx-btn--md qbx-btn--primary">
            Edit page
          </Link>
        </div>
      </div>
        ...
        <div className="flex items-center gap-3">
          <span
            ...
            style={{
              width: 32,
              height: 32,
              background: creator.whopConnectionStatus === "CONNECTED" ? "var(--success-soft)" : "var(--canvas-soft)",
              color: creator.whopConnectionStatus === "CONNECTED" ? "var(--success)" : "var(--ink-400)",
            }}
          >
          ...
          <div className="flex flex-col gap-0.5">
            <div className="text-[13.5px] font-semibold text-ink-900">
              {creator.whopConnectionStatus === "CONNECTED" ? "Connected to Whop" : "Whop disconnected"}
            </div>
            <div className="font-mono text-[11.5px] text-ink-400">
